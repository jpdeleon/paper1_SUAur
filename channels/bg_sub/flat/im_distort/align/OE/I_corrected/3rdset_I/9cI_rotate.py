#!/usr/bin/env python
"""
  This is the third part of 9I_rotate that rotates a total of 8 sets of *_I images.
  ...
  together with 184,188,..,212_I images.
  There are total of 8 output images (*_rotI.fits).
