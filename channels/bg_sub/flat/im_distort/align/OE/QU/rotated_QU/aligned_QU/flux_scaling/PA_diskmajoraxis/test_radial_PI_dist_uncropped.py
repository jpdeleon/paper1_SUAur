...
rotated_image1=rotate(obj_PI_fs_conv,angle1)
rotated_image2=rotate(obj_PI_fs_conv,angle2)
...
label195 = 'PI flux for PA = %d deg.' % angle1

#fit a power law with exponent p=-1
power_law_m1= constant1 * new_rscale1 ** p1
power_law_m2= constant2 * new_rscale2 ** p2
loglog(new_rscale1,image_ave1,'ko-',label=label15)
loglog(new_rscale2,image_ave2,'ks',mfc="None",label=label195) #unfilled circle
...
t,=loglog(new_rscale2,image_ave2,'ko',mfc="None")
...
loglog(new_rscale1,power_law_m1,'k-',label=label1)
loglog(new_rscale2,power_law_m2,'k--',label=label2)
