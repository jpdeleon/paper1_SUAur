...
plot([-70,0],[-110,-110], color='w', linestyle='-', linewidth=3) #AU
#put a NEWS arrow
plot([300,330],[-110,-110], color='w', linestyle='-', linewidth=3) #AU
plot([330,330],[-110,-80], color='w', linestyle='-', linewidth=3) #AU
...
axis([-150,400,-150,150]) #zoom
#axis([-200,400,-300,300]) #AU
#axis([-1.2,2.7,-1.5,1.5]) #arcsec
