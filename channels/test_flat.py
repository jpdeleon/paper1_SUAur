...
for filename1 in file_list1: #loop to all the science images (ch1b)
  fname1=filename1[:-5]+'f.fits' #remove 5 characters from the end of variable then append with p => HICA*bf)
  #print filename1,fname1
  iraf.imarith(filename1,'/','flat_ch1',fname1)#make flat field by dividing the corresponding flat channel and save it as 'HICA*bf.fits' 
